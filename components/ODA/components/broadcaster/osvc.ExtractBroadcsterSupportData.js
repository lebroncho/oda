...
function metadata(){
    return {
        name: 'osvc.ExtractBroadcasterSupportData',
        properties: {
            // GETTERS
...
async function invoke(context){
    context.logger().info("------ EXTRACT BROADCASTER SUPPORT DATA START ------");
    ...
    context.logger().info("------ EXTRACT BROADCASTER SUPPORT DATA END ------");
    return;
}
