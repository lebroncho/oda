...
function metadata(){
    return {
        name: 'osvc.ExtractControllerSupportData',
        properties: {
            // GETTERS
...
async function invoke(context){
    context.logger().info("------ EXTRACT CONTROLLER SUPPORT DATA START ------");
    ...
    context.logger().info("------ EXTRACT CONTROLLER SUPPORT DATA END ------");
    return;
}
