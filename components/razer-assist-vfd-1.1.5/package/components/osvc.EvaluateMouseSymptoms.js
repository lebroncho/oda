...
const symptoms = require("../json/mouseSymptoms.json");

class EvaluateMouseSymptoms {
  constructor() {
    //super();
  }
  ...
  invoke(conversation, done) {
    conversation.logger().info("------ EvaluateMouseSymptoms Invoked ------");
...
module.exports = EvaluateMouseSymptoms;