...
const symptoms = require("../json/laptopSymptoms.json");

class EvaluateLaptopSymptoms {
  constructor() {
    //super();
  }
  ...
  invoke(conversation, done) {
    conversation.logger().info("------ EvaluateLaptopSymptoms Invoked ------");
...
module.exports = EvaluateLaptopSymptoms;