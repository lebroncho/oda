...
function createMouseCaseNotes($issue, $deviceSymptoms, $deviceConnection, $deviceTsSteps, $deviceUpdated, $deviceOccurrence, $fileLocalFname, $rmaType, 
  $rmaPhone, $rmaShippingAddress, $rmaBillingAddress, $rmaPurchaseDate, $rmaPurchasePlace, $rmaCountry, $rmaZipPostal, $rmaStateProvince, $rmaCity,
  $rmaStreetAddress, $rmaFileLocalFname, $issueDescription) {
...
try {
    ...
    $mouseNotes = createMouseCaseNotes($issue, $deviceSymptoms, $deviceConnection, $deviceTsSteps, $deviceUpdated, $deviceOccurrence, $fileLocalFname, 
      $rmaType, $rmaPhone, $rmaShippingAddress, $rmaBillingAddress, $rmaPurchaseDate, $rmaPurchasePlace, $rmaCountry, $rmaZipPostal, $rmaStateProvince, 
      $rmaCity, $rmaStreetAddress, $rmaFileLocalFname, $issueDescription);
