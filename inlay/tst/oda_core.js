      ...
      if (event.key === "inlay-oracle-chat-embedded-chatStatus") {
        ...
        if (!isEmpty(status.chatStatus)) {
          ...
          if (status.chatStatus === "connected") {
            ...
            if(document.getElementById("inlay-oracle-chat-embedded").getElementsByTagName("textarea")[0])
              document.getElementById("inlay-oracle-chat-embedded").getElementsByTagName("textarea")[0].style.visibility = "visible !importat"
          }
